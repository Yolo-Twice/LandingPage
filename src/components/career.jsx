      ...
      <div className="p-8 bg-lxj-softWhite min-h-screen flex flex-col max-w-6xl mx-auto font-inter">
        ...
        <div className="bg-white border-2 border-gray-200 p-6 rounded-2xl shadow-md text-gray-800 text-lg leading-relaxed mb-10">
          <div className="columns-1 md:columns-2 gap-6 space-y-4">
            ...
            <p>
            Joining <span className="font-bold text-lxj-accent">Logi</span><span className="font-bold text-lxj-alert">Xjunction</span> means stepping into a dynamic, fast-paced environment where ideas turn into action and action drives real impact. As a mission-driven company, we value ownership, curiosity, and adaptability. You won’t just be doing a job — you’ll be part of a purpose-led journey to modernize one of the most crucial sectors of the Indian economy.
            </p>
            <p>
            No matter your role or experience level, you’ll have the freedom to experiment, learn, and grow. We provide the tools, mentorship, and flexibility needed to help you succeed — whether you're writing code, running campaigns, or supporting customers. At <span className="font-bold text-lxj-accent">Logi</span><span className="font-bold text-lxj-alert">Xjunction</span>, we’re not just building a logistics company — we’re building the future of freight.
            </p>
          </div>
        </div>
